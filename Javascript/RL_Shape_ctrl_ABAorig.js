...
var habituation = {
  ...
  timeline: [
    ...
    {
      stimulus: '<img src="sign.png" width= "304" height="280" style= "position: absolute;left: 50%; top:50%; margin-left:-152px; margin-top:-140px"/><img src="purplesquare.png" width="67" height="67" style= "position: absolute;left: 50%; top:50%; margin-left:48px; margin-top:-73px"/>',
      trial_duration: 600
    },
    {
      prompt:null,
    ...
    {
      stimulus: '<img src="sign.png" width= "304" height="280" style= "position: absolute; left: 50%; top:50%; margin-left:-152px; margin-top:-140px"/><img src="cyanoctagon.png" width="67" height="67" style= "position: absolute;left: 50%; top:50%; margin-left:48px; margin-top:-73px"/>',
      trial_duration: 600
    },
    {
      prompt:null,
    ...
    {
      stimulus: '<img src="sign.png" width= "304" height="280" style= "position: absolute; left: 50%; top:50%; margin-left:-152px; margin-top:-140px"/><img src="limepentagon.png" width="67" height="67" style= "position: absolute;left: 50%; top:50%; margin-left:48px; margin-top:-73px"/>',
      trial_duration: 600
    },
    {
      prompt:null,
    ...
    {
      stimulus: '<img src="sign.png" width= "304" height="280" style= "position: absolute; left: 50%; top:50%; margin-left:-152px; margin-top:-140px"/><img src="pinkheart.png" width="67" height="67" style= "position: absolute; left: 50%; top:50%; margin-left:48px; margin-top:-73px"/>',
      trial_duration: 600
    },
    {
      prompt:null,
...
var trial_2 = {
  ...
  timeline:[
    ...
    },
    {
      stimulus: `
      <img src="sign.png" width="304" height="280" style="position: absolute; left:35%;top:50%; margin-top: -140px; margin-left: -152px"/>
      <img src="yellowstar.png" width="67" height="67" style= "position: absolute; left:35%;top:50%; margin-top: -73px; margin-left: 48px"/>`,
      trial_duration: 600
    },
    {
      prompt:null,
...
var end_q2 = {
  ...
  questions:[
    {
      type:'survey-text',
      prompt: "<p>请输入您<b>手机号后四位数字</b>，便于我们记录您的答案，并与后续的问卷进行对应。</p>",
      required: true,
      name:"phone_num"
    },
    {
    ...
    {
      prompt: "请填写您的邮寄地址，以邮寄礼品",
      required: true,
      name:'address'
    },
    {
      type:'survey-text',
      prompt:'以防报酬发放出现问题，请填写用于联系的<b>微信号</b>，不方便提供请填“无”',
      name:'wechat',
      required: true
    },
    {
      type:'survey-text',
      prompt:'以防报酬发放出现问题，请填写用于联系的<b>手机号</b>，不方便提供请填“无”',
      name:'phone',
      required: true
    }
    ],
